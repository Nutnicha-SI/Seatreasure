...
<div class="banner">
        <img width="1000px" height="auto" src="img/homebn.gif">
    </div>
</div>
<div class="beforecontent">

    <br>
    <div class="alert alert-light" role="alert" style="text-align: center; font-size: larger; padding:0 ; margin : 0 auto ;color: #9F8D5E; width: 40%; height: 6%;">
    YOU MUST BE <a href="login.php" class="alert-link">LOGGED IN</a> BEFORE PLACING AN ORDER.
</div>
